...
function renderAdminPage() {
    ...
    document.getElementById('attractionsHeaderTitle').value = content.attractionsHeaderTitle || '';
    document.getElementById('attractionsHeaderText').value = content.attractionsHeaderText || '';
    document.getElementById('safariHeaderTitle').value = content.safariHeaderTitle || '';
    document.getElementById('safariHeaderText').value = content.safariHeaderText || '';
    document.getElementById('aboutHeaderTitle').value = content.aboutHeaderTitle || '';
    document.getElementById('aboutHeaderText').value = content.aboutHeaderText || '';
    document.getElementById('contactHeaderTitle').value = content.contactHeaderTitle || '';
    document.getElementById('contactHeaderText').value = content.contactHeaderText || '';
...
function saveAdminForm() {
    ...
    content.attractionsHeaderTitle = document.getElementById('attractionsHeaderTitle').value.trim() || defaultDashboardContent.attractionsHeaderTitle;
    content.attractionsHeaderText = document.getElementById('attractionsHeaderText').value.trim() || defaultDashboardContent.attractionsHeaderText;
    content.safariHeaderTitle = document.getElementById('safariHeaderTitle').value.trim() || defaultDashboardContent.safariHeaderTitle;
    content.safariHeaderText = document.getElementById('safariHeaderText').value.trim() || defaultDashboardContent.safariHeaderText;
    content.aboutHeaderTitle = document.getElementById('aboutHeaderTitle').value.trim() || defaultDashboardContent.aboutHeaderTitle;
    content.aboutHeaderText = document.getElementById('aboutHeaderText').value.trim() || defaultDashboardContent.aboutHeaderText;
    content.contactHeaderTitle = document.getElementById('contactHeaderTitle').value.trim() || defaultDashboardContent.contactHeaderTitle;
    content.contactHeaderText = document.getElementById('contactHeaderText').value.trim() || defaultDashboardContent.contactHeaderText;
